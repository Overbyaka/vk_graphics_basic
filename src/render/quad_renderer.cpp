...
{
  m_rect      = info.rect;
  m_programId = etna::create_program("quad_renderer", { VK_GRAPHICS_BASIC_ROOT "/resources/shaders/quad3_vert.vert.spv", VK_GRAPHICS_BASIC_ROOT "/resources/shaders/quad.frag.spv" });
...
void QuadRenderer::RecordCommands(vk::CommandBuffer cmdBuff, vk::Image targetImage, vk::ImageView targetImageView, const etna::Image &inTex, const etna::Sampler &sampler)
{
